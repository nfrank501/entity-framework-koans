...
namespace Koans.Data
{
    ...
    public partial class KoansEntities : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<FixedProduct> FixedProducts
        {
            get
            {
                if ((_FixedProducts == null))
                {
                    _FixedProducts = base.CreateObjectSet<FixedProduct>("FixedProducts");
                }
                return _FixedProducts;
            }
        }
        private ObjectSet<FixedProduct> _FixedProducts;
